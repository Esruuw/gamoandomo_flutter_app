          ...
          child: Column(
            children:<Widget> [
              ...
              Row(
                ...
                children: <Widget>[
                  FeaturesTile(
                    icon: Icon(Icons.map, color: Color(0xff1A4160),),
                    label: "Go to Map",
                  ...
                  // FeaturesTile(
                  //   icon: Icon(Icons.details, color: Color(0xff1A4160),),
                  ...
                  // ),
                  // FeaturesTile(
                  //   icon: Icon(Icons.share, color: Color(0xff1A4160),),
  ...
  child: Row(
    ...
    children: <Widget>[
      DetailsCard(
        ...
        title: "Sample Place", // Example value
        noOfReviews: "250 reviews", // Example value
      ),
    ],
  ),
),
