...
class CulturalButton extends StatefulWidget {
  @override
  _CulturalButton createState() => _CulturalButton();
   _CulturalButton createStatte() => new _CulturalButton();
}

class _CulturalButton extends State<CulturalButton> {
