...
class PersonalEmergencyContactsModel extends StatefulWidget {
  PersonalEmergencyContactsModel({required this.callBackFunction, required this.headerText, required this.headerBackgroundColor, required this.headerTextColor});
  ...
  @override
  _PersonalEmergencyContacts createState() => _PersonalEmergencyContacts();
}

// Country picker state class
class _PersonalEmergencyContacts extends State<PersonalEmergencyContactsModel> {
